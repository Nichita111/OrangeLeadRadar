...
2. Requirement rows: `S-ING-01` to `S-ING-06`, `S-SIG-01` to `S-SIG-10`, `S-PIP-01` to `S-PIP-05`, `S-SCO-01` to `S-SCO-08`, `S-RUN-02` in [system requirements](/requirements/system.md); `N-02`, `N-03`, `N-04`, `N-05`, `N-06`, `N-09`, `N-11`; `B-05`, `B-11` to `B-20`, `B-33`, `B-36`, `B-37`, `B-38`, `RULE-01` to `RULE-03`, `RULE-05`, `RULE-08` in [business requirements](/requirements/business.md).
...
9. Acceptance rows in [acceptance criteria](/requirements/acceptance.md): `AC-03`, `AC-04`, `AC-06`, `AC-11`, `AC-16` to `AC-40`, `AC-49`, `AC-58`, `AC-61` to `AC-64`, `AC-66`, `AC-69`, `AC-70`.
