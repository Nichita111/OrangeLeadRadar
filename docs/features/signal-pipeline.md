...
2. Requirement rows: `S-ING-01` to `S-ING-06`, `S-SIG-01` to `S-SIG-09`, `S-PIP-01` to `S-PIP-05`, `S-SCO-01` to `S-SCO-08`, `S-RUN-02` in [system requirements](/requirements/system.md); `N-02`, `N-03`, `N-04`, `N-05`, `N-06`, `N-09`, `N-11`; `B-05`, `B-11` to `B-20`, `B-33`, `RULE-01` to `RULE-03`, `RULE-05`, `RULE-08` in [business requirements](/requirements/business.md).
...
6. Services: the [worker](/architecture/services/worker.md) — job queue, run lifecycle, signal graph, AI gateway, source plug-ins, scheduler, runtime keys; the [api](/architecture/services/api.md) for enqueueing; the frontend's [Polling](/architecture/services/frontend.md#polling).
...
9. Acceptance rows in [acceptance criteria](/requirements/acceptance.md): `AC-11`, `AC-16` to `AC-40`, `AC-58`, `AC-61`, `AC-62`, `AC-64`, `AC-66`.
