...
* [Frontend](architecture/services/frontend.md) - The React web client - stack, routes and roles, navigation and service selector, screen states, screen labels, formatting, polling, tables and accessibility - with the shell-level FR rows every screen obeys and its configuration keys.
