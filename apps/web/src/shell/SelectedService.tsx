...
/**
 * FR-003: the service every screen shows, the user's choice among the `ACTIVE` services of `API-07`,
 * remembered per user in `localStorage`; with no valid choice, the first active service.
 */
...
export function useServiceSelection(): ServiceSelection {
  ...
  if (selection === null) {
    throw new Error("useServiceSelection needs a SelectedServiceProvider.");
  }
  return selection;
}
